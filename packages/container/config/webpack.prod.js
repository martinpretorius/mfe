  ...
  plugins: [
    new ModuleFederationPlugin({
      ...
      remotes: {
        ...
        marketingApp: `marketing@${domain}/marketing/latest/remoteEntry1.js`, // this key matches up to some import somewhere inside our container project, domain gets set when we create our infrastructure on amazon s3; whenever we want to find marketing then go to the cloudfront-domain/marketing/latest/remoteEntry.js and that will tell us how to load the code for our marketing app
      },
